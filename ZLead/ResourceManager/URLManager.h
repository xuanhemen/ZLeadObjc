...
static NSString * const ZLURL_AddGoodsClass = @"/ZlwGoods/addShopGoodsClass";//添加商品分类
...
static NSString * const ZLURL_GetShopClassLeve1 = @"/goods/getShopClassLeve1";//查询店铺分类
static NSString * const ZLURL_AddShopGoodsClass = @"/goods/addShopGoodsClass";//添加店铺分类
