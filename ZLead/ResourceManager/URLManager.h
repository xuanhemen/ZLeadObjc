...
static NSString * const ZLURL_GetPlatformGoodsList = @"/ZlwPlatformGoods/getPlatformGoodsList";//查询平台商品列表
...
static NSString * const ZLURL_GetShopClassTree = @"/ZlwGoods/getShopClassTree";//获取所有店铺分类
